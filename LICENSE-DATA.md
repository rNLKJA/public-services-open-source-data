...
- **Department for Housing and Urban Development data** (Land Division Applications; Planning and Design Code Zones): licensed under [CC BY 3.0 AU](http://creativecommons.org/licenses/by/3.0/au/) per the licence file bundled with the data itself (the CKAN portal record's `license_id` field claims CC BY 4.0 — see `datasets/sa-land-division-applications/README.md` and `datasets/sa-planning-zones/README.md` for the discrepancy).
