...
- [ ] SA public sector workforce and employment (Office of the Commissioner for Public Sector Employment: workforce information, classification/FTE counts, gender pay gap reporting) — partially reviewed 2026-07-06 (see run log); no genuinely current statewide dataset found yet, left open rather than struck for a fuller future pass
